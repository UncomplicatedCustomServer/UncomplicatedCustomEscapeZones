...
namespace UncomplicatedEscapeZones
{
    internal class Plugin : Plugin<Config>
    {
        ...
        public override string Description { get; } = "Customize your SCP:SL server with Custom Escape Zones!";
        ...
        public override void Enable()
        {
            ...
            {
                LogManager.Debug($"Loaded zone: Name: {customEscapeZone.Id} | EscapeRoles: {customEscapeZone.RoleAfterEscape}");
            }
        }
