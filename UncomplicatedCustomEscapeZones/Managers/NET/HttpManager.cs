...
internal class HttpManager
{
    ...
    /// </summary>
    public Dictionary<string, Triplet<string, string, bool>> Credits { get; private set; } = new();
    ...
    /// <summary>
    ///     Compares two releases, treating the revision as the pre-release number of the release it belongs to
    /// </summary>
    ...
    /// <summary>
    ///     Gets whether the given version is a pre-release
    /// </summary>
    ...
    /// <summary>
    ///     Loads every version of the plugin known by the UCS cloud
    /// </summary>
    public CoroutineHandle LoadVersions()
    {
        return Timing.RunCoroutine(LoadVersionsCoroutine(), "UCEZ_Http");
    }
    ...
    /// <summary>
    ///     Gets the message that tells where the given version can be downloaded from
    /// </summary>
    ...
    /// <summary>
    ///     Loads the CreditTags from the UCS Central Server
    /// </summary>
