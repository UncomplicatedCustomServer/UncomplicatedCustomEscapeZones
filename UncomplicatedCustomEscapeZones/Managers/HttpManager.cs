...
#pragma warning disable IDE1006
    ...
    internal class HttpManager
    {
        ...
        {
            content = HttpQuery.Post($"{Endpoint}/{Prefix}/error?port={Server.Port}&exiled_version={LabApiProperties.CurrentVersion}&using_labapi=true&plugin_version={Plugin.Instance.Version.ToString(4)}", data, "text/plain");
